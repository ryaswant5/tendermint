...
- Blockchain Protocol
  ...
  - [evidence] [\#4780](https://github.com/tendermint/tendermint/pull/4780) Cap evidence to an absolute number (@cmwaters)
    - Note that this is superceded by #5499, below
...
- [statesync] [\#5399](https://github.com/tendermint/tendermint/pull/5399) Add `discovery_time` configuration setting, and reduce default to 15s. (@erikgrinaker)
...
- [consensus] [\#4970](https://github.com/tendermint/tendermint/pull/4970) Stricter on `LastCommitRound` check (@cuonglm)
...
- [proxy] [\#5078](https://github.com/tendermint/tendermint/pull/5078) Fix a bug, where TM does not exit when ABCI app crashes (@melekes)
